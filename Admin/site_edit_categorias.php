...
session_start();
	if(isset($_SESSION["restuname"]) && isset($_SESSION["restprofile"]) && $_SESSION["restprofile"]=="A"){
		...
		$titulo="ADMINISTRACI�N CATEGORIAS DE PRODUCTOS";
		...
		if($actividad=="ver"){
			...
			$gettabla = $dataTables->armaTablaDyRel($tabla,$Pkey,$Ftablas,$Fkeys,$Fnames,$sender,$titulo,$Ncamps,$Ntypes,$Nalias,"1",1,1,0,"null","null");
			...
			$Nalias=$relaciones[$tabla]["alias"];
			$Ntypes=$relaciones[$tabla]["tipos"];
			$gettabla = $dataTables->devuelveTablaEditItemDyRel($tabla,$Pkey,$Vkey,$Ftablas,$Fkeys,$Fnames,$sender,$titulo,$Ncamps,$Ntypes,$Nalias,"null","null",array(),"./iconos/","null",$dialogo,0,"loader(\'$sender?flag=ver\')");
			...
			$Nalias=$relaciones[$tabla]["alias"];
			$Ntypes=$relaciones[$tabla]["tipos"];
			$gettabla = $dataTables->devuelveTablaNewItemDyRel($tabla,$Pkey,$Ftablas,$Fkeys,$Fnames,$sender,$titulo,$Ncamps,$Ntypes,$Nalias,"null","null",array(),"","./iconos/",$rnd_table,$dialogo,0,0,"loader(\'$sender?flag=ver\')");
			echo $gf->utf8($gettabla);
