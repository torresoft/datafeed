...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Mostrar _MENU_ Regs",sZeroRecords:"No matching records found",sEmptyTable:"No hay registros en la tabla",
sLoadingRecords:"Loading...",sInfo:"Mostrando _START_ a _END_ de _TOTAL_ Regs",sInfoEmpty:"Mostrando 0 a 0 de 0 Regs",sInfoFiltered:"(Filtrado de _MAX_ total registros)",sInfoPostFix:"",sInfoThousands:",",sSearch:"Buscar:",sUrl:"",oPaginate:{sFirst:"Primera",sPrevious:"Ant",sNext:"Sig",sLast:"Ultima"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
